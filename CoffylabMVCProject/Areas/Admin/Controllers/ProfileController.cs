...
using AdminEntity = CoffylabMVCProject.Entities.Admin;
...
namespace CoffylabMVCProject.Areas.Admin.Controllers
{
    ...
    public class ProfileController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Index(AdminEntity updatedAdmin)
        {
        ...
        [HttpPost]
        public IActionResult ChangePassword(AdminEntity updatedAdmin)
        {
            if (!ModelState.IsValid) return View(updatedAdmin);
